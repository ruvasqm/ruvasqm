...
const Footer = () => (
    <footer className='flex flex-col items-center justify-center lg:justify-around space-y-5  lg:space-y-20 min-h-full lg:h-auto w-full p-5 lg:pt-16 bg-secondary text-white font-bold unselectable snap-end snap-normal'>
