...
const SEO = ({title = resume.basics.name} : { title?:string}) => (
    <Head>
        ...
        <meta property="og:image" content={`${resume.basics.url}/api/og?height=630&width=1200`}/>
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:image:url"  content={`${resume.basics.url}/api/og?height=630&width=1200`}/>

        {/*<!-- Twitter Meta Tags -->*/}
        <meta name="twitter:card" content="summary_large_image"/>
        <meta property="twitter:domain" content={resume.basics.url.replace('https://', '')}/>
        <meta property="twitter:url" content={resume.basics.url}/>
        <meta name="twitter:title" content={title}/>
        <meta name="twitter:description" content={resume.basics.summary}/>
        <meta name="twitter:image" content={`${resume.basics.url}/api/og?height=630&width=1200`}/>
