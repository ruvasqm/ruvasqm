...
const Page: NextPage = () => {
    ...
    <>
        ...
        <main className='flex flex-col items-start min-h-auto print:h-auto w-full bg-secondary text-white p-5 md:p-14 space-y-3 print:block'>
            ...
            <section id='_about' className='flex flex-col items-start justify-start w-full sm:h-auto print:block'>
            ...
            <section id='_skills' className='flex flex-col items-start justify-start w-full h-fit print:block'>
            ...
            <section id='_experience' className='flex flex-col items-start justify-start w-full h-fit print:block'>
                ...
                <div className='flex flex-col items-start justify-start w-full h-full print:block'>
                    {resume.work.map((job) => (
                        <div key={job.name} className='flex flex-col items-start justify-start w-full h-full p-3  print:break-inside-avoid-page print:block'>
            ...
            <section id='_education' className='flex flex-col items-start justify-start w-full h-fit'>
                ...
                <div className='flex flex-col items-start justify-start w-full h-full'>
                    {resume.education.map((school) => (
                        <div key={school.institution} className='flex flex-col items-start justify-start w-full h-full p-3 print:break-inside-avoid-page print:block'>
            ...
            <section id='_languages' className='flex flex-col items-start justify-start w-full h-auto print:grow'>
                ...
                <div className='flex flex-row flex-wrap items-start justify-start w-full h-full'>
                    {resume.languages.map((language) => (
                        <div key={language.language} className='flex flex-col items-start justify-start p-3 print:break-inside-avoid-page print:block'>
